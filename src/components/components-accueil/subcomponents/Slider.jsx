      ...
      >
        <div>
          <img
            ...
            alt="Des tacos"
          ></img>
          <p className="legend">Le Gourmand</p>
        </div>
        <div>
          <img
            ...
            alt="Des tacos"
          ></img>
          <p className="legend">Le Spécial Mexicain</p>
        </div>
        <div>
          <img
            ...
            alt="Des tacos"
          ></img>
          <p className="legend">Le Chocobo Party</p>
        </div>
        <div>
          <img
            ...
            alt="Des tacos"
          ></img>
          <p className="legend">Le Végétarien</p>
        </div>
        <div>
          <img
            ...
            alt="Des tacos"
          ></img>
          <p className="legend">Le Raffiné</p>
        </div>
      </Carousel>
    </div>
  );
